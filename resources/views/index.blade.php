...
<body>
  ...
  <header id="header" class="header fixed-top d-flex align-items-center">
    <div class="container d-flex align-items-center justify-content-between">
      ...
      <a class="btn-book-a-table" href="#book-a-table">Reservasi</a>
    ...
    <div class="container">
      <div class="row justify-content-between gy-5">
        <div class="col-lg-5 order-2 order-lg-1 d-flex flex-column justify-content-center align-items-center align-items-lg-start text-center text-lg-start">
          <h2 data-aos="fade-up">Nikmati Kesehatan Anda<br> Dengan Makanan Sehat</h2>
          <p data-aos="fade-up" data-aos-delay="100">Jadikan Waroeng kami sebagai tujuan makanan sehat dan lezat Anda. Kami siap melayani Anda dengan kasih sayang dan kualitas hidangan yang terbaik.</p>
          <div class="d-flex" data-aos="fade-up" data-aos-delay="200">
            <a href="#book-a-table" class="btn-book-a-table">Reservasi</a>
            <a href="https://youtu.be/zioKMGJySpg?si=2tGYVNGYEgg9B9NI" class="glightbox btn-watch-video d-flex align-items-center"><i class="bi bi-play-circle"></i><span>Lihat Video</span></a>
          </div>
        </div>
      ...
      <div class="container" data-aos="fade-up">
        ...
        <div class="row gy-4">
          ...
          <div class="col-lg-4" data-aos="fade-up" data-aos-delay="100">
            <div class="why-box">
              <h3>Mengapa memilih Waroeng?</h3>
              <p>
              Kami menyajikan menu Asian food dengan cita rasa autentik serta penuh gizi.
              Kami melayani sepenuh hati untuk para pelanggan. 
            ...
            <div class="row gy-4">
              ...
              <div class="col-xl-4" data-aos="fade-up" data-aos-delay="200">
                <div class="icon-box d-flex flex-column justify-content-center align-items-center">
                  ...
                  <h4>Komposisi gizi seimbang di setiap menu</h4>
              ...
              <div class="col-xl-4" data-aos="fade-up" data-aos-delay="300">
                <div class="icon-box d-flex flex-column justify-content-center align-items-center">
                  <i class="bi bi-gem"></i>
                  <h4>Menggunakan bahan-bahan yang segar dan premium</h4>
              ...
              <div class="col-xl-4" data-aos="fade-up" data-aos-delay="400">
                <div class="icon-box d-flex flex-column justify-content-center align-items-center">
                  ...
                  <h4>Menggunakan kemasan yang ramah lingkungan</h4>
      ...
      <div class="row gy-3">
        <div class="col-lg-3 col-md-6 d-flex">
          ...
          <div>
            <h4>Address</h4>
            <p>
              T380 Soekarno Hatta Street <br>
              Malang, Malang 140223 - ID<br>
            </p>
          </div>
        ...
        <div class="col-lg-3 col-md-6 footer-links d-flex">
          ...
          <div>
            ...
            <p>
              ...
              <strong>Email:</strong> waroengresto@gmail.com<br>
            </p>
          </div>
        </div>
